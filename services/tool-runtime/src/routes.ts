...
export function toStartExecutionInput(body: ExecuteBody): StartExecutionInput {
  return {
    userId: body.userId,
    tool: body.tool,
    args: body.args,
...
export async function registerToolRuntimeRoutes(app: FastifyInstance): Promise<void> {
