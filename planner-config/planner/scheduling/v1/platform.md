Platform scheduling tools (always available — no Connect Apps required):
...
- automation.create REQUIRED args: cronExpression, timezone, query (plain English — NOT tool IDs like email.list_unread). Optional name/pushTitle.
