...
-- CreateEnum
CREATE TYPE "ReminderStatus" AS ENUM ('PENDING', 'PAUSED', 'FIRED', 'CANCELLED', 'FAILED');
...
-- CreateIndex
CREATE INDEX "Reminder_userId_status_deletedAt_idx" ON "Reminder"("userId", "status", "deletedAt");
